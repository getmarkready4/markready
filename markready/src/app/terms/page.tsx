...
// Text supplied by the founder (Mark Ready ToS, September 2026), rendered
// verbatim apart from: two link placeholders resolved to the live pages, two
// line-wrap duplicates from the source document removed, and a handful of
// missing spaces at wrapped words restored.
...
const SECTIONS: Section[] = [
  {
    heading: "OVERVIEW",
    paragraphs: [
      `This website is operated by Mark Ready. Throughout the site, the terms “we”, “us” and “our” refer to Mark Ready. Mark Ready offers this website, including all information, tools and Services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.`,
  ...
  },
  {
    ...
    paragraphs: [
      `You agree to indemnify, defend and hold harmless Mark Ready and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.`,
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      `Questions about the Terms of Service should be sent to us at getmarkready@gmail.com.`,
    ],
  },
];
...
function withPolicyLinks(text: string): ReactNode[] {
  return text.split(/(\[LINK TO RETURN POLICY\]|\[LINK TO PRIVACY POLICY\])/).map((part, i) => {
    if (part === "[LINK TO RETURN POLICY]") {
            ...
            <section key={section.heading}>
              ...
              <div className="space-y-3">
                {section.paragraphs.map((paragraph, i) => (
                  <p key={i}>{withPolicyLinks(paragraph)}</p>
                ))}
              </div>
            </section>
          ))}
